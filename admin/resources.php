...
if ( isset( $_POST['create'] ) ) {
    ...
    $GLOBALS['POSTS'] -> name = empty( $_POST['name'] ) ? 'name' : htmlentities($_POST['name']);
    $GLOBALS['POSTS'] -> author = empty( $_POST['author'] ) ? 1 : $_POST['author'];
    $GLOBALS['POSTS'] -> author_name = empty( $_POST['author_name'] ) ? 'Author' : $_POST['author_name'];
    ...
    $GLOBALS['POSTS'] -> gallery = empty( $_POST['gallery'] ) ?  'none' :  $_POST['gallery'];
    $GLOBALS['POSTS'] -> authkey = empty( $_POST['authkey'] ) ? str_shuffle( generateCode() ) : $_POST['authkey'];
    $GLOBALS['POSTS'] -> level = empty( $_POST['level'];
    $link = preg_replace('/\s+/', '-', empty( $_POST['name'] );
    ...
    $GLOBALS['POSTS'] -> readings = empty( $_POST['readings'];
    $GLOBALS['POSTS'] -> status = empty( $_POST['status'];
    $GLOBALS['POSTS'] -> subtitle = empty( $_POST['subtitle'];
    $GLOBALS['POSTS'] -> tags = strtolower( $_POST['tags'] );
    $GLOBALS['POSTS'] -> template = strtolower( $_POST['template'] );
    $GLOBALS['POSTS'] -> type = empty( $_POST['type'];
    $GLOBALS['POSTS'] -> updated = empty( $_POST['updated'];
